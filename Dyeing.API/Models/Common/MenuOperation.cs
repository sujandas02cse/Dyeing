...
namespace Dyeing.API.Model
{
    public class MenuOperation : Base
    {
        ...
        public Task<IEnumerable<ListOfMenus>> GetParentMenu(string userId)
        {
            var parameters = new DynamicParameters();
            parameters.Add(name: "@UserName", value: userId, dbType: DbType.String, direction: ParameterDirection.Input);
            parameters.Add(name: "@MainModuleId", value: "18", dbType: DbType.String, direction: ParameterDirection.Input);
            return DatabaseHub.QueryAsync<ListOfMenus>(
                    storedProcedureName: @"[dbo].[sp_GetMenuInformation]", parameters: parameters, dbName: ControlPanel);
        }
    }
}

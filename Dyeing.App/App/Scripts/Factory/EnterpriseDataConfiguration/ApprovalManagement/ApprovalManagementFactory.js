app.factory("ApprovalManagement", [
  "$http",
  function($http) {
    var _obj = {};
    ...
    _obj.GetBodypart = function(BpmId, cb) {
      $http
        .get(
          baseApiURL + "ApprovalManagement/GetBodyPartbyBatch?BpmId=" + BpmId
        )
        .then(
          function successCallback(response) {
            cb(response.data);
    ...
    _obj.GetBatchNoByUnit = function(unitNo, cb) {
      $http
        .get(baseApiURL + "CommonAPI/GetInspectionBatch?UnitId=" + unitNo)
        .then(
          function successCallback(response) {
            cb(response.data);
          },
    ...
    _obj.GetCRApprovalBatchList = function(UnitId, cb) {
      $http
        .get(
          baseApiURL +
            "ApprovalManagement/GetCRApproveBatchList?UnitId=" +
            UnitId
        )
        .then(
          function successCallback(response) {
    ...
    _obj.GetApprovalBatchData = function(BpmId, cb) {
      $http
        .get(
          baseApiURL + "ApprovalManagement/GetApproveBatchData?BpmId=" + BpmId
        )
        .then(
          function successCallback(response) {
            cb(response.data);
    ...
    _obj.GetShadeApprovalBatchData = function(
      BpmId,
      ApprovalTime,
      BSpecId,
      cb
      ...
      $http
        .get(
          baseApiURL +
            "ApprovalManagement/GetShadeApproveBatchData?BpmId=" +
            BpmId +
            "&ApprovalTime=" +
            ApprovalTime +
            "&BSpecId=" +
    ...
    _obj.GetRFDApprovalBatchData = function(BpmId, cb) {
      $http
        .get(
          baseApiURL +
            "ApprovalManagement/GetRFDApproveBatchData?BpmId=" +
            BpmId
        )
        .then(
          function successCallback(response) {
    ...
    _obj.GetFTSApprovalBatchData = function(BpmId, cb) {
      $http
        .get(
          baseApiURL +
            "ApprovalManagement/GetFTSApproveBatchData?BpmId=" +
            BpmId
        )
        .then(
          function successCallback(response) {
    ...
    _obj.GetAllTypeApprovalBatchData = function(
      BpmId,
      ApprovalType,
      ApprovalTime,
      cb
      ...
      $http
        .get(
          baseApiURL +
            "ApprovalManagement/GetAllApproveBatchData?BpmId=" +
            BpmId +
            "&ApprovalType=" +
            ApprovalType +
            "&ApprovalTime=" +
    ...
    _obj.SaveUpdateApprovalData = function(data, cb) {
      $http
        .post(
          baseApiURL + "ApprovalManagement/SaveOrUpdateBatchApproveData",
          data
        )
        .then(
          function successCallback(response) {
    ...
    _obj.SaveUpdateFTSApprovalData = function(data, cb) {
      $http
        .post(baseApiURL + "ApprovalManagement/SaveUpdateFTSApprovalData", data)
        .then(
          function successCallback(response) {
            cb(response.data);
          },
    ...
    _obj.SaveUpdateShadeApprovalData = function(data, cb) {
      $http
        .post(
          baseApiURL + "ApprovalManagement/SaveUpdateShadeApprovalData",
          data
        )
        .then(
          function successCallback(response) {
    ...
    _obj.GetBatchNoByUnitNew = function(batchType, unitNo, cb) {
      debugger;
      $http
        .get(
          baseApiURL +
      ...
      _obj.GetAllTypeApprovalBatchDataNew = function (
          BpmId,
          ApprovalType,
          ApprovalTime,
          cb
          ...
          $http
              .get(
                  baseApiURL +
                  "ApprovalManagement/GetAllApproveBatchDataNew?BpmId=" +
                  BpmId +
                  "&ApprovalType=" +
                  ApprovalType +
                  "&ApprovalTime=" +
      ...
      _obj.SaveUpdateApprovalDataNew = function (data, cb) {
          debugger;
          $http
              .post(
                  baseApiURL + "ApprovalManagement/SaveOrUpdateBatchApproveDataNew",
                  data
              )
              .then(
                  function successCallback(response) {

app.factory("BatchDataProcessing", [
  "$http",
  function($http) {
    var _obj = {};
    ...
    _obj.GetMachineDataByPlan = function(data, cb) {
      $http
        .post(baseApiURL + "BatchPreparation/GetMachineDataByPlan", data)
        .then(
    ...
    _obj.GetDataByBatch = function(BpmId, cb) {
      $http
        .get(baseApiURL + "BatchPreparation/GetDataByBatch?BpmId=" + BpmId)
        .then(
          function successCallback(response) {
            cb(response.data);
          },
    ...
    _obj.GetBatchAll = function(cb) {
      $http.get(baseApiURL + "CommonApi/GetBatchAll").then(
        function successCallback(response) {
          cb(response.data);
        },
        function errorCallback(response) {
    ...
    _obj.GetDressPart = function(cb) {
      $http.get(baseApiURL + "CommonMerchandisingApi/GetDressPart").then(
        function successCallback(response) {
          cb(response.data);
        },
        function errorCallback(response) {
    ...
    _obj.GetFabricNameByPlan = function(data, cb) {
      $http
        .post(baseApiURL + "BatchPreparation/GetFabricNameByPlan", data)
        .then(
          function successCallback(response) {
            cb(response.data);
          },
    ...
    _obj.GetDiaInfoByFabric = function(data, cb) {
      $http.post(baseApiURL + "BatchPreparation/GetDiaInfoByFabric", data).then(
        function successCallback(response) {
          cb(response.data);
        },
        function errorCallback(response) {
    ...
    _obj.GetTrollyNo = function(unitId, cb) {
      $http.get(baseApiURL + "CommonAPI/GetTrollyNo?unitId=" + unitId).then(
        function successCallback(response) {
          cb(response.data);
        },
        function errorCallback(response) {
    ...
    _obj.GetBarcodeData = function(data, cb) {
      $http.post(baseApiURL + "CommonAPI/GetBarcodeData", data).then(
        function successCallback(response) {
          cb(response.data);
        },
        function errorCallback(response) {
    ...
    _obj.GetBatchNoAndPlanNo = function(cb) {
      $http.get(baseApiURL + "BatchPreparation/GetPlanList").then(
        function successCallback(response) {
          cb(response.data);
        },
        function errorCallback(response) {
    ...
    _obj.BatchDataProcessing_SaveUpdate = function(data, cb) {
      $http
        .post(
          baseApiURL + "BatchPreparation/BatchDataProcessing_SaveUpdate",
          data
        )
        .then(
          function successCallback(response) {
    ...
    _obj.BatchDataProcessingSample_SaveUpdate = function(data, cb) {
      ...
      $http
        .post(
          baseApiURL + "BatchPreparation/BatchDataProcessingSample_SaveUpdate",
          data
        )
        .then(
          function successCallback(response) {
    ...
    _obj.BatchFabData_Update = function(data, cb) {
      $http
        .post(baseApiURL + "BatchPreparation/BatchFabData_Update", data)
        .then(
          function successCallback(response) {
            cb(response.data);
          },
    ...
    _obj.GetBatchProcessingData = function(unitId, fromDate, toDate, cb) {
      $http
        .get(
          baseApiURL +
            "DataRelatedDashboard/GetBatchProcessingData?unitId=" +
            unitId +
            "&&fromDate=" +
            fromDate +
            "&&toDate=" +
    ...
    _obj.GetBatchReprocessData = function(unitId, fromDate, toDate, cb) {
      $http
        .get(
          baseApiURL +
            "BatchPreparation/GetBatchReprocessData?unitId=" +
            unitId +
            "&&fromDate=" +
            fromDate +
            "&&toDate=" +
    ...
    _obj.GetDyeingProcessFlowInfo = function(cb) {
      $http
        .get(baseApiURL + "DyeingProcessFlow/DyeingProcessFlowInfoActive_Get")
        .then(
          function successCallback(response) {
            cb(response.data);
          },

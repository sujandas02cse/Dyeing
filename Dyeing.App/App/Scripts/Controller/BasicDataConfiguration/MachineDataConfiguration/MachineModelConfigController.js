app.controller("MachineModelConfigController", ['$scope', '$rootScope', '$filter', '$mdDialog', '$mdToast', 'MachineConfig', function ($scope, $rootScope, $filter, $mdDialog, $mdToast, MachineConfig) {
    GetMachineInfo('0', 'Model');
        ...
        $mdDialog.show(
            $mdDialog.dialogBox({
                ...
                if (mode == 'Update' || mode == 'Save') {
                    MachineConfig.GetMachineInfo('0', 'Model', function (data) {
    ...
    function objData(action) {
        ...
        if (action == 'Save') {
            ...
            obj = { 'Mode': 'Update', 'btnText': 'Yes', 'Header': 'Update Confirmation', 'message': 'Do you want to update Machine Model Configuration Data?' };
        } else if (action == 'Delete') {
            obj = { 'Mode': 'Delete', 'btnText': 'Yes', 'Header': 'Delete Confirmation', 'message': 'Do you want to delete Machine Model Configuration Data?' };
        }
        return obj;
    }
    function chkValidation() {
        ...
        if ($scope.btnSave == "Save" && chkDup.length > 0) {
            $rootScope.alert("Duplicate Model Not Allowed, Please! Enter Valid Model Name.....");
            return "0";

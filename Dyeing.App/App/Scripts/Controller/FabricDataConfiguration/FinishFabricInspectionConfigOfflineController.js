  ...
  function(
    ...
    function GetMaximumCompactingTime(BatchNo) {
      ...
      FinishFabricInspectionConfigOffline.GetMaximumCompactingTime(
        ...
        function(data) {
          debugger;
          $scope.MaxCompTime = data[0].MaxCompTime;
        }
      );
    }
    ...
    function SaveUpdate() {
      ...
      /*var fixedCompactingTime = GetMaximumCompactingTime(GetMainBatchNo());*/

      // GetMaximumCompactingTime(GetMainBatchNo());

      var fixedCompactingTime = $scope.MaxCompTime;
    ...
    $scope.enterBatchClick = function() {
      ...
      LoadDetailsByBatch($scope.batchType, GetMainBatchNo());

      LoadBodyPartsByBatch($scope.batchType, GetMainBatchNo());
    };
    ...
    $scope.LoadDiaGSM = function() {
      ...
      IsSecondCompactingON($scope.batchType, GetMainBatchNo(), function(
        maxCompTime
      ) {
        debugger;

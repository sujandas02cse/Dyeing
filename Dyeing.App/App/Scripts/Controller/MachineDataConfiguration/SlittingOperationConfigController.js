app.controller("SlitOperationConfigController", [
  "$scope",
  "$rootScope",
  "$mdDialog",
  "$mdToast",
  ...
  function(
    ...
    //McOperationConfigFactory.GetFinMcByType("Slitting", function(data) {
    ...
    $scope.getDataByBatchId = function() {
      ...
      McOperationConfigFactory.GetDataByBatchIdDetailNew(
        ...
        function(
          data
        ) // McOperationConfigFactory.GetDataByBatchIdDetail(batchId, pCompTime, 'GetSlittingData', function (data)
        {
    ...
    function SaveUpdate() {
      ...
      $scope.McOperation.Operation = "SaveSlittingData";

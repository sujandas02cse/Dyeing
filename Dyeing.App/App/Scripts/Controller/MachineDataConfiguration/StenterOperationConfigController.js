app.controller("StenterOperationConfigController", [
  "$scope",
  "$rootScope",
  "$mdDialog",
  "$mdToast",
  ...
  function(
    ...
    //McOperationConfigFactory.GetFinMcByType("Stenter", function(data) {
    ...
    $scope.getDataByBatchId = function() {
      ...
      // McOperationConfigFactory.GetDataByBatchIdDetail(batchId, pCompTime, 'GetStenterData', function (data)
      ...
      McOperationConfigFactory.GetDataByBatchIdDetailNew(
        ...
        function(data) {
          ...
          //Updated By Sujan Das on 15-April-2025
          //$scope.McOperation.MachineNo = $scope.MachineList[0];
          ...
          //updated on 31/12/2024 to keep similar
          //with CompactingMcOperationController.js
    ...
    function SaveUpdate() {
      ...
      $scope.McOperation.Operation = "SaveStenterData";

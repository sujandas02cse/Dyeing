app.controller("TumbleDryerMcOpConfigController", ["$scope", "$rootScope", "$mdDialog", "$mdToast", "$q", "$parse", "fileReader", "$window", "NewMcOperationConfigFactory", function (
    ...
    $scope.getDataByBatchId = function () {
        ...
        debugger
        NewMcOperationConfigFactory.GetDataByBatchIdDetailNew(batchId, pCompTime, status, "TumbleDryer", function (data) {
            debugger

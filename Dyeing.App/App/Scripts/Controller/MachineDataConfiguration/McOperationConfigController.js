app.controller("McOperationConfigController", [
  "$scope",
  "$rootScope",
  "$mdDialog",
  "$mdToast",
  ...
  function(
    ...
    /*updated by Sujan Das on 13-April-2025*/
    ...
    $scope.getDataByBatchId = function() {
      ...
      McOperationConfigFactory.GetDataByBatchIdDetailNew(
        ...
        status,
        function(
          data //McOperationConfigFactory.GetDataByBatchIdDetail(batchId, pCompTime, 'GetDataByBatchId', function (data)
        ) {
    ...
    function SaveUpdate() {
      ...
      $scope.McOperation.Operation = "SaveData";

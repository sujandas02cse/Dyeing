app.controller("MachineDetailsConfigController", ['$scope', '$rootScope', '$mdDialog', '$mdToast', 'MachineDetailsConfig', function ($scope, $rootScope, $mdDialog, $mdToast, MachineDetailsConfig) {
    ...
    MachineDetailsConfig.GetMachinesearchCapacity(function (data) {
        angular.forEach(data, function (val, key) {
            var vd = { value: val["MCapacityId"], display: val["CapacityName"].toString() };
    ...
    function SaveUpdate() {
        ...
        MachineDetailsConfig.MachineDetails_SaveUpdate($scope.Model, function (data) {
    ...
    function GetMachineDetail() {
        MachineDetailsConfig.GetMachineDetail(function (data) { $scope.MachineDetailsInfo = data; $scope.totalItems = data.length; });
    }
    ...
    function Delete(dataModel) {
        MachineDetailsConfig.DeleteMachineDetail(dataModel.MDId, $scope.UserId, function (data) {
    ...
    $scope.GetMachineDetailByID = function (dataModel) {
        ...
        if (dataModel.MachineName != null) {
            $scope.selectedName = { value: dataModel.MachineId, display: dataModel.MachineName };
        }
        if (dataModel.MachineType != null) {
            $scope.selectedType = { value: dataModel.MTypeId, display: dataModel.MachineType };
        }
        if (dataModel.ItemBrandName != null) {
            $scope.selectedBrand = { value: dataModel.MBrandId, display: dataModel.ItemBrandName };
        }
        if (dataModel.MachineModel != null) {
            $scope.selectedModel = { value: dataModel.MModelId, display: dataModel.MachineModel };
        }
        if (dataModel.CapacityName != null) {
            $scope.selectedCapacity = { value: dataModel.MCapacityId, display: dataModel.CapacityName.toString() };
        }
        if (dataModel.AssetNo != null) {
            $scope.selectedAsset = { value: dataModel.AssetId, display: dataModel.AssetNo };
        }
        if (dataModel.UnitEName != null) {
            $scope.selectedUnitName = { value: dataModel.UnitId, display: dataModel.UnitEName };
        }
    };

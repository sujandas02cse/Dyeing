  ...
  function(
    ...
    $scope.FinishingConfiguration = function(ev) {
      $mdDialog.show({
        ...
        templateUrl:
          "/App/template/Popup/BatchConfigFinishDialog.html?ts=" + ts,
        targetEvent: ev,
        scope: $scope,
        preserveScope: true,
    ...
    function DataValidation() {
      ...
      for (var i = 0; i < $scope.RecipeList.length; i++) {
        if (
          $scope.RecipeList[i].RecipeDrescription == "" ||
          $scope.RecipeList[i].Unit == ""
        ) {
          return true;
        }
      }
    ...
    $scope.getDataByBatchId = function(ob) {
      ...
      BatchFinishingFactory.GetBatchConfigurationFinishingDetail(
        batchId,
        function(data) {
          debugger;
          console.log(data);
    ...
    function SaveUpdate() {
      ...
      BatchFinishingFactory.SaveBatchConfigurationFinishing(obj, function(
        data
      ) {

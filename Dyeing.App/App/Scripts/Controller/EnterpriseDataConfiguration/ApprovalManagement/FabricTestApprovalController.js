app.controller("FabricTestApproval", ['$scope', '$window', '$rootScope', '$mdDialog', 'ApprovalManagement', function ($scope, $window, $rootScope, $mdDialog, ApprovalManagement) {
    debugger
    ...
    $scope.getDataByBatchId = function () {
        if ($scope.Batch.BpmId > 0) {
            ...
            $scope.BatchData = ApprovalManagement.GetAllTypeApprovalBatchData($scope.Batch.BpmId, 'FabricTest', pAppTime, function (data) {

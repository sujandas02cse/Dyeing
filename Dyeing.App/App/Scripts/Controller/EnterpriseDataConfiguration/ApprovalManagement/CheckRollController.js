app.controller("CheckRoll", ['$scope', '$window', '$rootScope', '$mdDialog', '$mdToast', 'ApprovalManagement', function ($scope, $window, $rootScope, $mdDialog, $mdToast, ApprovalManagement) {
    ...
    $scope.getDataByBatchId = function () {
        ...
        ApprovalManagement.GetAllTypeApprovalBatchData($scope.Batch.BpmId, 'CheckRoll', pAppTime, function (data) {
            debugger
            ...
            $scope.CRA = apRec[0].CRollApproved = undefined ? false : apRec[0].CRollApproved;
            $scope.CA = apRec[0].ComApproved = undefined ? false : apRec[0].ComApproved;
    ...
    $scope.actionDialog = function (action, dataModel) {        
        ...
        if (($scope.CRA == undefined            
            && $scope.CA == undefined) 
            || (($scope.CRA != true && $scope.CRAN != true)

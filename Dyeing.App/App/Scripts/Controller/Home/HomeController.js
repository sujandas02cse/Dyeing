app.controller("HomeController", ['$scope', '$rootScope', '$mdDialog', '$mdToast', '$q', '$parse', 'Home', function ($scope, $rootScope, $mdDialog, $mdToast, $q, $parse, Home) {
	...
	$scope.getDataByMenuId = function (i) {
		debugger;
        var menuId = $scope.CurrentMenuData[i].ManuId;
        $scope.CurrentMenuData = $scope.MenuList.filter(x => x.ParantManuId == menuId);
	}
	...
	//		{
	//			name: "Fauzan Khan",
	//			imageUrl: "https://mis-merchant.mascoknit.com/App_Theme/main_components/assets/images/MascoLogo.png"
	//		},
	//		{
	//			name: "Keanu Reeves",

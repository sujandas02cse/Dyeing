app.controller("JobWiseRftStatusController", ['$scope', '$timeout', '$window', '$rootScope', 'filterFilter', '$mdDialog', 'MonthlyQualityInspectionSummary', function ($scope, $timeout, $window, $rootScope, filterFilter, $mdDialog, MonthlyQualityInspectionSummary) {
    ...
    $scope.LoadingData = function (Unit, Buyer, Job, RYear, RMonth) {
        ...
        debugger
        MonthlyQualityInspectionSummary.GetJobWiseRftStatus(Unit.UnitId, BuyerId, JobId, RYear, RMonth, function (data) {
            debugger
    ...
    $scope.DownloadPdf = function (Unit, Buyer, Job, RYear, RMonth) {
        ...
        $window.open('../DashboardManagement/GET_JobWiseRftStatus?UnitId=' + Unit.UnitId + '&BuyerId=' + BuyerId +
